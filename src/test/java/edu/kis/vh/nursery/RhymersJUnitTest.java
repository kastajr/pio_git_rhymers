...
public class RhymersJUnitTest {
	...
	final public static int TEST_VALUE = 4;
	final public static int INT = 888;
	final public static int STACK_CAPACITY = 12;
	final public static int I = 0;
	final public static int INT1 = 888;
	final public static int EMPTY_STACK_VALUE = -1;
	final public static int TEST_VALUE1 = 4;
	final public static int EMPTY_STACK_VALUE1 = -1;
	final public static int TEST_VALUE2 = 4;
	...
	public void testPeekaboo() {
		...
		final int testValue = TEST_VALUE1;
		rhymer.countIn(testValue);
	...
	public void testCountOut() {
		...
		final int testValue = TEST_VALUE2;
		rhymer.countIn(testValue);
